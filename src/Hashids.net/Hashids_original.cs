...
namespace HashidsNet
{
    ...
    /// </summary>
    public class Hashids_original : IHashids
    {
        ...
        /// </summary>
        public Hashids_original() : this(string.Empty, 0, DEFAULT_ALPHABET, DEFAULT_SEPS)
        { }
        ...
        public Hashids_original(string salt = "", int minHashLength = 0, string alphabet = DEFAULT_ALPHABET, string seps = DEFAULT_SEPS)
        {
